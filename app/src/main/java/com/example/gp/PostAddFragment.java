...
import com.example.gp.databinding.FragmentPostAddBinding;
...
public class PostAddFragment extends Fragment {
    private FragmentPostAddBinding B;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        B = FragmentPostAddBinding.inflate(inflater,container,false);
        View view = B.getRoot();
                ...
                db.collection("MemberData")
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        try {
                            ...
                            Posts.put("PostGroup",task.getResult().get("group").toString());
