...
public final class ActivityIndexBinding implements ViewBinding {
  ...
  private ActivityIndexBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout frameLayout,
  ...
  public static ActivityIndexBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityIndexBinding((ConstraintLayout) rootView, frameLayout, navigation);
    }
