...
public final class FragmentPostUpdateBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPostUpdateBinding(@NonNull FrameLayout rootView, @NonNull LinearLayout Linear,
  ...
  @NonNull
  public static FragmentPostUpdateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPostUpdateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_post_update, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPostUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPostUpdateBinding((FrameLayout) rootView, Linear, PostEdText, PostImg,
